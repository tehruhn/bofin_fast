...
# print([elem for sl in eta_list for elem in sl])
# print(gamma_list)
import time
start = time.time()
resultHEOM1=FermionicHEOMSolver(H0, Qops,  eta_list, gamma_list, Ncc)
end = time.time()
# print(end - start)

start = time.time()
# print(resultHEOM1)
B=resultHEOM1.run(rho_0,tlist)
# print(expect(B.states[-1],d1.dag()*d1))
end = time.time()
