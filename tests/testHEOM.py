...
class TestHEOM(TestCase):
    ...
    def test_fermionic_HEOM_py(self):
        """
        Test for Python Fermionic HEOM Solver.
        ...
        # Define parameters
        Gamma, W, T, beta = 0.01, 1., 0.025851991, 1./0.025851991
        theta, mu_l, mu_r = 2., 1., 1.
        ...
        resultHEOM1 = FermionicHEOMSolverPy(H0, Qops,  eta_list, gamma_list, Ncc,options=options)
    ...
    def test_fermionic_HEOM_cpp(self):
        """
        Test for C++ Fermionic HEOM Solver.
        Compares numerical and analytical results.
        """
        ...
        resultHEOM1 = FermionicHEOMSolverCPP(H0, Qops,  eta_list, gamma_list, Ncc,options=options)
